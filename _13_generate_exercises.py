...
```"""
        ...
        system_content = f"""Твоя задача – сгенерировать {count} открытый вопрос уровня сложности {difficulty}.

Требования:
1. Вопросы должны быть разнообразными и не повторять предыдущие.
2. Для вопроса предоставь модельный ответ и критерии оценки.
3. Правильно овтетить на вопрос можно толко прочитав и поняв учебный материал.
4. Вопросы должны быть разнообразными и не повторять предыдущие.
